...
include("conexao.php");
$inclui="INSERT INTO DTC (DTC_CDRORI,DTC_CDRDES,DTC_CGCPAG,DTC_NFEID,DTC_TIPDOC,DTC_NUMNFC,DTC_QTDVOL,DTC_DATREC,DTC_PROCES,DTC_FORNEC,DTC_STATUS,DTC_CGCFOR) VALUES ('$CDRORI','$CDRDES','$CNPJ','$NFEID','$TipDoc','$NumNFC','$QTDVol','$DATREC','$proces','$FORNEC','0','$CGCFOR')";	
