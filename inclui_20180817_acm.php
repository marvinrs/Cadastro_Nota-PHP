...
<title>Cadastro de Documentacao</title>
<style type="text/css">
div.rolagem {
...
<form id="documento" name="documento" method="post" action="inclusao.php" onsubmit="return is_cnpj(document.documento.CNPJ.value); return false;">
  <table width="100%" border="0">
    ...
    <tr>
	  ...
	  <tr>
		<td>Chave NFE:</td>
	    <td><input type="tel" placeholder="Digite o numero da Chave da Nota" pattern="\s*(\S\s*){44,}" name="NFEID" id="NFEID" title="Digite os 44 digitos da Chave da Nota (Apenas numeros)" size="40" maxlength="44" required=""/> <span class="style1">*</span></td>
	  </tr>
	<tr>
